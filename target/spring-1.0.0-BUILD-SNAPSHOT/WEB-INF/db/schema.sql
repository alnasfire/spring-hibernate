...
insert into `user` set `login`='admin', `password`='admin', `roleid`=1, `email`='igor-nas@tut.by';
insert into `user` set `login`='head', `password`='head', `roleid`=2, `email`='igor-nas@tut.by';
insert into `user` set `login`='user', `password`='user', `roleid`=3, `email`='igor-nas@tut.by';

insert into `teststate` set `value`='выдан';
insert into `teststate` set `value`='выполняется';
insert into `teststate` set `value`='выполнен';
insert into `teststate` set `value`='проверяется';
insert into `teststate` set `value`='утвержден';
insert into `teststate` set `value`='не утвержден';